...
declare module "csv-parse/sync" {
  export function parse(input: string, options?: Record<string, unknown>): Array<Record<string, string>>;
}
...
declare module "next/navigation" {
  ...
  export function useRouter(): { replace(path: string, options?: any): void; push(path: string, options?: any): void; };
  export function useSearchParams(): { get(name: string): string | null; toString(): string; };
}
